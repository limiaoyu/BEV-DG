...
def parse_args():
    ...
    parser.add_argument('--ckpt2d', type=str, help='path to checkpoint file of the 2D model', default='')
    parser.add_argument('--ckpt3d', type=str, help='path to checkpoint file of the 3D model', default='')
